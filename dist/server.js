...
app.post('/api/process', async (req, res) => {
    try {
        ...
        const result = await (0, pipeline_1.processTranscript)(transcript);
...
app.get('/api/simulate/first', async (req, res) => {
    try {
        ...
        await (0, pipeline_1.simulateFirst)();
        ...
        (0, pipeline_1.resetState)();
        pipelineLogs = [];
        isCapturingLogs = true;
        const result = await (0, pipeline_1.processTranscript)(testTranscript);
        isCapturingLogs = false;
        res.json({
            result,
...
app.get('/api/simulate/hundred', async (req, res) => {
    try {
        ...
        isCapturingLogs = true;
        (0, pipeline_1.resetState)();
        (0, pipeline_1.generateMockEntries)(99);
        const testTranscript = "I keep checking Slack even when I'm exhausted. I know I need rest, but I'm scared I'll miss something important.";
        pipelineLogs = [];
        isCapturingLogs = true;
        const result = await (0, pipeline_1.processTranscript)(testTranscript);
